...
const FooterSection = () => {
    return (
        <footer className="flex flex-col w-full bg-foreground mt-24 max-sm:px-16">
            <ScrollVelocity
                texts={FooterText}
                velocity={50}
                damping={70}
            ...
            />
            <div className="flex justify-between items-center w-full px-6 h-20 border-t-[1.5px] border-[#ffffff1a] ">
